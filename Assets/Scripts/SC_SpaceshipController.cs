...
public class SC_SpaceshipController : MonoBehaviour
{
    ...
    void FixedUpdate()
    {
        ...
        //     rotationZTmp = -1;
        // }
        rotationZTmp = Input.GetAxis("Horizontal") * -1;
        //rotationZTmp = Mathf.Lerp(mouseXSmooth, Input.GetAxis("Horizontal") * rotationSpeed, Time.deltaTime * cameraSmooth);
        mouseYSmooth = Mathf.Lerp(mouseYSmooth, Input.GetAxis("Vertical") * rotationSpeed * -1, Time.deltaTime * cameraSmooth);
